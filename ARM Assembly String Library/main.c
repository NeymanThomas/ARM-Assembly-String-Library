...
// The following C code was made in order to test the effectiveness
// of the self implemented string.h library in ARM Assembly. The
// Following code goes through all of the implemented functions in
// the library and determines if they function properly or not.
